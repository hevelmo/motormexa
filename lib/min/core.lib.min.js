!function(e, t) {
    ...
    function u(e, t, n) {
        var r;
        if (void 0 === n && 1 === e.nodeType) if (r = "data-" + t.replace(xe, "-$1").toLowerCase(), 
    ...
    function b(e) {
        var t = J, n = We[e];
        return n || ("none" !== (n = x(e, t)) && n || (Re = (Re || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), 
        (t = Re[0].contentDocument).write(), t.close(), n = x(e, t), Re.detach()), We[e] = n), 
        n;
    }
    function w(e, t, n) {
        var r, i, o, s, a = e.style;
        return (n = n || Ie(e)) && (s = n.getPropertyValue(t) || n[t]), n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), 
        Be.test(s) && $e.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, 
    ...
    function k(e, t, n, r, i) {
        ...
        r ? ("content" === n && (s -= Z.css(e, "padding" + we[o], !0, i)), "margin" !== n && (s -= Z.css(e, "border" + we[o] + "Width", !0, i))) : (s += Z.css(e, "padding" + we[o], !0, i), 
        "padding" !== n && (s += Z.css(e, "border" + we[o] + "Width", !0, i)));
        return s;
    }
    function E(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, o = Ie(e), s = "border-box" === Z.css(e, "boxSizing", !1, o);
        if (0 >= i || null == i) {
            if ((0 > (i = w(e, t, o)) || null == i) && (i = e.style[t]), Be.test(i)) return i;
            r = s && (Q.boxSizingReliable() || i === e.style[t]), i = parseFloat(i) || 0;
        }
        return i + k(e, t, n || (s ? "border" : "content"), r, o) + "px";
    }
    function S(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) (r = e[s]).style && (o[s] = me.get(r, "olddisplay"), 
        n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Te(r) && (o[s] = me.access(r, "olddisplay", b(r.nodeName)))) : (i = Te(r), 
        "none" === n && i || me.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
    ...
    function q(e, t, n) {
        var r, i, o, s, a, u, l, c = this, f = {}, p = e.style, d = e.nodeType && Te(e), h = me.get(e, "fxshow");
        n.queue || (null == (a = Z._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, u = a.empty.fire, 
        ...
        l = Z.css(e, "display"), "inline" === ("none" === l ? me.get(e, "olddisplay") || b(e.nodeName) : l) && "none" === Z.css(e, "float") && (p.display = "inline-block")), 
        ...
        if (Z.isEmptyObject(f)) "inline" === ("none" === l ? b(e.nodeName) : l) && (p.display = l); else {
            h ? "hidden" in h && (d = h.hidden) : h = me.access(e, "fxshow", {}), o && (h.hidden = !d), 
            ...
            for (r in f) s = L(d ? h[r] : 0, r, c), r in h || (h[r] = s.start, d && (s.end = s.start, 
    ...
    function H(e, t) {
        ...
        o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = Z.cssHooks[r]) && "expand" in s) {
    ...
    function O(e, t, n) {
        var r, i, o = 0, s = et.length, a = Z.Deferred().always(function() {
            ...
            if (i) return !1;
            for (var t = Ge || D(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, s = l.tweens.length; s > o; o++) l.tweens[o].run(r);
            return a.notifyWith(e, [ l, r, n ]), 1 > r && s ? n : (a.resolveWith(e, [ l ]), 
            !1);
        }, l = a.promise({
            elem: e,
            props: Z.extend({}, t),
    ...
    Z.fn = Z.prototype = {
        ...
        each: function(e, t, r) {
            ...
            if (r) {
                if (s) for (;o > i && !1 !== t.apply(e[i], r); i++) ; else for (i in e) if (!1 === t.apply(e[i], r)) break;
            } else if (s) for (;o > i && !1 !== t.call(e[i], i, e[i]); i++) ; else for (i in e) if (!1 === t.call(e[i], i, e[i])) break;
            return e;
        },
        trim: function(e) {
        ...
        map: function(e, t, r) {
            ...
            if (n(e)) for (;s > o; o++) null != (i = t(e[o], o, r)) && a.push(i); else for (o in e) null != (i = t(e[o], o, r)) && a.push(i);
            return z.apply([], a);
        },
        guid: 1,
        proxy: function(e, t) {
    ...
    var ie = function(e) {
        function t(e, t, n, r) {
            ...
            if (q && !r) {
                if (i = me.exec(e)) if (s = i[1]) {
                    ...
                    if ((s = i[3]) && x.getElementsByClassName && t.getElementsByClassName) return J.apply(n, t.getElementsByClassName(s)), 
                    n;
                }
                if (x.qsa && (!H || !H.test(e))) {
                    if (d = p = M, h = t, g = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (f = C(e), (p = t.getAttribute("id")) ? d = p.replace(ye, "\\$&") : t.setAttribute("id", d), 
                        d = "[id='" + d + "'] ", l = f.length; l--; ) f[l] = d + c(f[l]);
        ...
        function m(e) {
            ...
            } ]; i > a; a++) if (n = b.relative[e[a].type]) d = [ f(p(d), n) ]; else {
                if ((n = b.filter[e[a].type].apply(null, e[a].matches))[M]) {
        ...
        var y, x, b, w, T, C, N, k, E, S, j, D, A, L, q, H, O, F, P, M = "sizzle" + -new Date(), R = e.document, W = 0, $ = 0, B = n(), I = n(), _ = n(), z = function(e, t) {
            return e === t && (j = !0), 0;
        }, X = "undefined", U = 1 << 31, V = {}.hasOwnProperty, Y = [], G = Y.pop, Q = Y.push, J = Y.push, K = Y.slice, Z = Y.indexOf || function(e) {
        ...
        x = t.support = {}, T = t.isXML = function(e) {
            ...
            return n !== A && 9 === n.nodeType && n.documentElement ? (A = n, L = n.documentElement, 
            q = !T(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                D();
            ...
            }, O = [], H = [], (x.qsa = ge.test(n.querySelectorAll)) && (i(function(e) {
                e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && H.push("[*^$]=" + te + "*(?:''|\"\")"), 
                e.querySelectorAll("[selected]").length || H.push("\\[" + te + "*(?:value|" + ee + ")"), 
                e.querySelectorAll(":checked").length || H.push(":checked");
            }), i(function(e) {
                var t = n.createElement("input");
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && H.push("name" + te + "*[*^$|!~]?="), 
                ...
                x.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), O.push("!=", oe);
            }), H = H.length && new RegExp(H.join("|")), O = O.length && new RegExp(O.join("|")), 
            t = ge.test(L.compareDocumentPosition), P = t || ge.test(L.contains) ? function(e, t) {
                ...
                1 & r || !x.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === R && P(R, e) ? -1 : t === n || t.ownerDocument === R && P(R, t) ? 1 : S ? Z.call(S, e) - Z.call(S, t) : 0 : 4 & r ? -1 : 1);
            } : function(e, t) {
                if (e === t) return j = !0, 0;
            ...
            if ((e.ownerDocument || e) !== A && D(e), n = n.replace(le, "='$1']"), !(!x.matchesSelector || !q || O && O.test(n) || H && H.test(n))) try {
                var r = F.call(e, n);
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(xe, be), e[3] = (e[3] || e[4] || e[5] || "").replace(xe, be), 
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [ s ? m.firstChild : m.lastChild ], s && y) {
                                for (d = (l = (c = m[M] || (m[M] = {}))[e] || [])[0] === W && l[1], p = l[0] === W && l[2], 
                                f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop(); ) if (1 === f.nodeType && ++p && f === t) {
                                    c[e] = [ W, d, p ];
                                    break;
                                }
                            } else if (y && (l = (t[M] || (t[M] = {}))[e]) && l[0] === W) p = l[1]; else for (;(f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[M] || (f[M] = {}))[e] = [ W, p ]), 
                            f !== t)); ) ;
        ...
        return l.prototype = b.filters = b.pseudos, b.setFilters = new l(), C = t.tokenize = function(e, n) {
            ...
            for (a = e, u = [], l = b.preFilter; a; ) {
                ...
                for (s in b.filter) !(i = pe[s].exec(a)) || l[s] && !(i = l[s](i)) || (r = i.shift(), 
                o.push({
                    value: r,
                    type: s,
                    matches: i
            ...
            if (n = n || [], 1 === p.length) {
                ...
                for (i = pe.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !b.relative[a = s.type]); ) if ((l = b.find[a]) && (r = l(s.matches[0].replace(xe, be), ve.test(o[0].type) && u(t.parentNode) || t))) {
                    if (o.splice(i, 1), !(e = r.length && c(o))) return J.apply(n, r), n;
                    break;
                }
            }
            return (f || N(e, p))(r, t, !q, n, ve.test(e) && u(t.parentNode) || t), n;
        }, x.sortStable = M.split("").sort(z).join("") === M, x.detectDuplicates = !!j, 
        D(), x.sortDetached = i(function(e) {
    ...
    (Z.fn.init = function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            return (r = J.getElementById(n[2])) && r.parentNode && (this.length = 1, this[0] = r), 
            this.context = J, this.selector = e, this;
        }
        return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : Z.isFunction(e) ? void 0 !== ue.ready ? ue.ready(e) : e(Z) : (void 0 !== e.selector && (this.selector = e.selector, 
        this.context = e.context), Z.makeArray(e, this));
    }).prototype = Z.fn, ue = Z(J);
    var ce = /^(?:parents|prev(?:Until|All))/, fe = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    Z.extend({
        ...
        Z.fn[e] = function(n, r) {
            ...
            this.length > 1 && (fe[e] || Z.unique(i), ce.test(e) && i.reverse()), this.pushStack(i);
        };
    });
    var pe = /\S+/g, de = {};
    Z.Callbacks = function(e) {
        var t, n, r, i, s, a, u = [], l = !(e = "string" == typeof e ? de[e] || o(e) : Z.extend({}, e)).once && [], c = function(o) {
    ...
    Z.fn.ready = function(e) {
        ...
        ready: function(e) {
            (!0 === e ? --Z.readyWait : Z.isReady) || (Z.isReady = !0, !0 !== e && --Z.readyWait > 0 || (he.resolveWith(J, [ Z ]), 
            Z.fn.triggerHandler && (Z(J).triggerHandler("ready"), Z(J).off("ready"))));
        }
    }), Z.ready.promise = function(t) {
        return he || (he = Z.Deferred(), "complete" === J.readyState ? setTimeout(Z.ready) : (J.addEventListener("DOMContentLoaded", s, !1), 
        e.addEventListener("load", s, !1))), he.promise(t);
    }, Z.ready.promise();
    ...
    Z.acceptData = function(e) {
        ...
        remove: function(e, t) {
            ...
            if (void 0 === t) this.cache[o] = {}; else {
                ...
                r = r in s ? [ r ] : r.match(pe) || [])), n = r.length;
                for (;n--; ) delete s[r[n]];
            }
        },
        hasData: function(e) {
    ...
    Z.extend({
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = ve.get(o), 1 === o.nodeType && !me.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; ) s[n] && 0 === (r = s[n].name).indexOf("data-") && (r = Z.camelCase(r.slice(5)), 
                    u(o, r, i[r]));
        ...
        queue: function(e, t, n) {
            var r;
            return e ? (t = (t || "fx") + "queue", r = me.get(e, t), n && (!r || Z.isArray(n) ? r = me.access(e, t, Z.makeArray(n)) : r.push(n)), 
            r || []) : void 0;
        },
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--; ) (n = me.get(o[s], e + "queueHooks")) && n.empty && (r++, 
            n.empty.add(a));
            return a(), i.promise(t);
        }
    });
    var be = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, we = [ "Top", "Right", "Bottom", "Left" ], Te = function(e, t) {
        return e = t || e, "none" === Z.css(e, "display") || !Z.contains(e.ownerDocument, e);
    }, Ce = /^(?:checkbox|radio)$/i;
    !function() {
        var e = J.createDocumentFragment().appendChild(J.createElement("div")), t = J.createElement("input");
        t.setAttribute("type", "radio"), t.setAttribute("checked", "checked"), t.setAttribute("name", "t"), 
        e.appendChild(t), Q.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked, 
        e.innerHTML = "<textarea>x</textarea>", Q.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue;
    }();
    var Ne = "undefined";
    ...
    Z.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, s, a, u, l, c, f, p, d, h, g, m = me.get(e);
            ...
            }), l = (t = (t || "").match(pe) || [ "" ]).length; l--; ) a = je.exec(t[l]) || [], 
            ...
            d = (i ? f.delegateType : f.bindType) || d, f = Z.event.special[d] || {}, c = Z.extend({
                ...
                namespace: h.join(".")
            }, o), (p = u[d]) || (p = u[d] = [], p.delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, s) || e.addEventListener && e.addEventListener(d, s, !1)), 
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                for (l = (t = (t || "").match(pe) || [ "" ]).length; l--; ) if (a = je.exec(t[l]) || [], 
                d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                    for (f = Z.event.special[d] || {}, p = u[d = (r ? f.delegateType : f.bindType) || d] || [], 
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !Se.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), 
            ...
            f = Z.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                return t.type = d, i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !Z.acceptData(r) || l && Z.isFunction(r[d]) && !Z.isWindow(r) && ((a = r[l]) && (r[l] = null), 
                Z.event.triggered = d, r[d](), Z.event.triggered = void 0, a && (r[l] = a)), t.result;
            }
        },
        dispatch: function(e) {
            e = Z.event.fix(e);
            ...
            if (a[0] = e, e.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, e)) {
                ...
                e.data = o.data, void 0 !== (r = ((Z.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)) && !1 === (e.result = r) && (e.preventDefault(), 
                e.stopPropagation()));
        ...
        on: function(e, t, n, r, i) {
            ...
            n = void 0) : (r = n, n = t, t = void 0)), !1 === r) r = c; else if (!r) return this;
    ...
    var De = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ae = /<([\w:]+)/, Le = /<|&#?\w+;/, qe = /<(?:script|style|link)/i, He = /checked\s*(?:[^=]|=\s*.checked.)/i, Oe = /^$|\/(?:java|ecma)script/i, Fe = /^true\/(.*)/, Pe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Me = {
    ...
    Me.th = Me.td, Z.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++) if ((i = e[p]) || 0 === i) if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [ i ] : i); else if (Le.test(i)) {
                for (o = o || c.appendChild(t.createElement("div")), s = (Ae.exec(i) || [ "", "" ])[1].toLowerCase(), 
            ...
            o = v(c.appendChild(i), "script"), u && g(o), n)) for (l = 0; i = o[l++]; ) Oe.test(i.type || "") && n.push(i);
            return c;
        },
        ...
        html: function(e) {
            return ge(this, function(e) {
                ...
                if ("string" == typeof e && !qe.test(e) && !Me[(Ae.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    e = e.replace(De, "<$1></$2>");
                    try {
                        for (;r > n; n++) 1 === (t = this[n] || {}).nodeType && (Z.cleanData(v(t, !1)), 
                        t.innerHTML = e);
                        t = 0;
                    } catch (e) {}
                }
        ...
        domManip: function(e, t) {
            ...
            1 === n.childNodes.length && (n = r), r)) {
                for (o = (i = Z.map(v(n, "script"), d)).length; l > u; u++) s = n, u !== f && (s = Z.clone(s, !0, !0), 
                o && Z.merge(i, v(s, "script"))), t.call(this[u], s, u);
                if (o) for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++) s = i[u], 
                Oe.test(s.type || "") && !me.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Pe, "")));
            }
            return this;
        }
    }), Z.each({
    ...
    var Re, We = {}, $e = /^margin/, Be = new RegExp("^(" + be + ")(?!px)[a-z%]+$", "i"), Ie = function(e) {
    ...
    var _e = /^(none|table(?!-c[ea]).+)/, ze = new RegExp("^(" + be + ")(.*)$", "i"), Xe = new RegExp("^([+-])=(" + be + ")", "i"), Ue = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Ve = {
    ...
    Z.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : ("string" === (o = typeof n) && (i = Xe.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), 
        ...
        css: function(e, t, n, r) {
            ...
            return t = Z.cssProps[a] || (Z.cssProps[a] = C(e.style, a)), (s = Z.cssHooks[t] || Z.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), 
            void 0 === i && (i = w(e, t, r)), "normal" === i && t in Ve && (i = Ve[t]), "" === n || n ? (o = parseFloat(i), 
        ...
        css: function(e, t) {
            return ge(this, function(e, t, n) {
                var r, i, o = {}, s = 0;
                if (Z.isArray(t)) {
                    for (r = Ie(e), i = t.length; i > s; s++) o[t[s]] = Z.css(e, t[s], !1, r);
                    return o;
                }
    ...
    var Ge, Qe, Je = /^(?:toggle|show|hide)$/, Ke = new RegExp("^(?:([+-])=|)(" + be + ")([a-z%]*)$", "i"), Ze = /queueHooks$/, et = [ q ], tt = {
        "*": [ function(e, t) {
            var n = this.createTween(e, t), r = n.cur(), i = Ke.exec(t), o = i && i[3] || (Z.cssNumber[e] ? "" : "px"), s = (Z.cssNumber[e] || "px" !== o && +r) && Ke.exec(Z.css(n.elem, e)), a = 1, u = 20;
            if (s && s[3] !== o) {
                o = o || s[3], i = i || [], s = +r || 1;
                do {
    ...
    Z.Animation = Z.extend(O, {
        ...
        stop: function(e, t, n) {
            ...
            this.each(function() {
                var t = !0, i = null != e && e + "queueHooks", o = Z.timers, s = me.get(this);
                if (i) s[i] && s[i].stop && r(s[i]); else for (i in s) s[i] && s[i].stop && Ze.test(i) && r(s[i]);
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"), this.each(function() {
                var t, n = me.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = Z.timers, s = r ? r.length : 0;
        ...
        Q.optDisabled = !n.disabled, (e = J.createElement("input")).value = "t", e.type = "radio", 
    ...
    Z.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === Ne ? Z.prop(e, t, n) : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), 
            r = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? nt : void 0)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = Z.find.attr(e, t), 
    ...
    Z.fn.extend({
        ...
        prop: function(e, t, n) {
            var r, i, o = e.nodeType;
            if (e && 3 !== o && 8 !== o && 2 !== o) return (1 !== o || !Z.isXMLDoc(e)) && (t = Z.propFix[t] || t, 
    ...
    Z.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(Z.isFunction(e) ? function(n) {
                ...
                if ("string" === n) for (var t, r = 0, i = Z(this), o = e.match(pe) || []; t = o[r++]; ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else (n === Ne || "boolean" === n) && (this.className && me.set(this, "__className__", this.className), 
                this.className = this.className || !1 === e ? "" : me.get(this, "__className__") || "");
            });
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(ot, " ").indexOf(t) >= 0) return !0;
            return !1;
        }
    });
    var st = /\r/g;
    Z.fn.extend({
        ...
        valHooks: {
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, s = o ? null : [], a = o ? i + 1 : r.length, u = 0 > i ? a : o ? i : 0; a > u; u++) if (!(!(n = r[u]).selected && u !== i || (Q.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
    ...
    try {
        ...
        (ct = J.createElement("a")).href = "", ct = ct.href;
    }
    lt = vt.exec(ct.toLowerCase()) || [], Z.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(e, t) {
            function n(e, t, n, s) {
                ...
                u ? (f.ifModified && ((b = w.getResponseHeader("Last-Modified")) && (Z.lastModified[i] = b), 
                (b = w.getResponseHeader("etag")) && (Z.etag[i] = b)), 204 === e || "HEAD" === f.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, 
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || ct) + "").replace(ft, "").replace(mt, lt[1] + "//"), 
            f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(pe) || [ "" ], 
            null == f.crossDomain && (u = vt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === lt[1] && u[2] === lt[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (lt[3] || ("http:" === lt[1] ? "80" : "443")))), 
            f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), 
            P(yt, f, t, w), 2 === x) return w;
            (l = f.global) && 0 == Z.active++ && Z.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), 
            f.hasContent = !gt.test(f.type), i = f.url, f.hasContent || (f.data && (i = f.url += (ut.test(i) ? "&" : "?") + f.data, 
            delete f.data), !1 === f.cache && (f.url = pt.test(i) ? i.replace(pt, "$1_=" + at++) : i + (ut.test(i) ? "&" : "?") + "_=" + at++)), 
            f.ifModified && (Z.lastModified[i] && w.setRequestHeader("If-Modified-Since", Z.lastModified[i]), 
            Z.etag[i] && w.setRequestHeader("If-None-Match", Z.etag[i])), (f.data && f.hasContent && !1 !== f.contentType || t.contentType) && w.setRequestHeader("Content-Type", f.contentType), 
    ...
    Z.ajaxSetup({
        ...
        t.converters["script json"] = function() {
            ...
            e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, At.push(i)), s && Z.isFunction(o) && o(s[0]), 
            s = o = void 0;
        }), "script") : void 0;
    ...
    Z.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, s, a, u, l = Z.css(e, "position"), c = Z(e), f = {};
            "static" === l && (e.style.position = "relative"), a = c.offset(), o = Z.css(e, "top"), 
            u = Z.css(e, "left"), ("absolute" === l || "fixed" === l) && (o + u).indexOf("auto") > -1 ? (r = c.position(), 
            s = r.top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(u) || 0), Z.isFunction(t) && (t = t.call(e, n, a)), 
        ...
        offset: function(e) {
            ...
            return o ? (t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== Ne && (i = r.getBoundingClientRect()), 
            n = B(o), {
